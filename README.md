...
# Si le terminal affiche une erreur error: externally-managed-environment, essayer cela :
# pip install flask opencv-python-headless numpy pillow --break-system-packages
